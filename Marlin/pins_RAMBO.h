...
#define Z_MS1_PIN          68
#define Z_MS2_PIN          67
#define E0_MS1_PIN         63 //changed from 65
#define E0_MS2_PIN         64 //changed from 66
#define E1_MS1_PIN         65 //changed from 63
#define E1_MS2_PIN         66 //changed from 64
...
// Temperature Sensors
//
#define TEMP_0_PIN          1   // Analog Input. Changed from 0 to 1
#define TEMP_1_PIN          0   // Analog Input. Changed from 1 to 0
#define TEMP_BED_PIN        2   // Analog Input

//
// Heaters / Fans
//
#define HEATER_0_PIN        7 //changed from 9 to 7
#define HEATER_1_PIN        9 //changed from 7 to 9
